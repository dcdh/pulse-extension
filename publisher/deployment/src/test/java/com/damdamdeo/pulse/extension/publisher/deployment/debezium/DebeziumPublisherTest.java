...
class DebeziumPublisherTest extends AbstractPublisherTest {
    ...
    void shouldConsumeFromTEventKafkaTopic() {
        ...
        assertAll(
                ...
                () -> assertThat(getValuesByKey(headers, "__debezium.context.runId")).isNotEmpty(),
                () -> assertThat(getValuesByKey(headers, "__source_version")).containsExactly("3.5.0.Final"),
                ...
                () -> assertThat(getValuesByKey(headers, "__source_schema")).containsExactly("todo_taking"),
