...
public class StubInvolvedFinder implements InvolvedFinder {
    ...
    public Page<Involved> findBy(final AggregateId aggregateId, final IncludeUncompounded includeUncompounded, final Pagination pagination) throws FinderException {
        ...
        return new Page<>(
                List.of(
                        new Involved(TodoId.USER_1_TODO_1, new Actor(new ExecutedByHashed("EU:alice-hashed"), new ExecutedBy.EndUser(new Username("alice@mail.com"))), new NbOfTimes(1)),
                        new Involved(TodoId.USER_1_TODO_1, new Actor(new ExecutedByHashed("EU:bob-hashed"), new ExecutedBy.EndUser(new Username("bob@mail.com"))), new NbOfTimes(1))),
