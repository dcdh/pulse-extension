...
class StateApplierTest {
    ...
    void shouldApplyEvents() {
        ...
        final StateApplier<Todo, TodoId> todoStateApplier = new StateApplier<>(
                ...
                TodoId.class, new TodoId(UserId.USER_1, TodoId.SEQUENCE_NUMBER_1));

        // Then
        assertAll(
                () -> assertThat(todoStateApplier.aggregate().id()).isEqualTo(new TodoId(UserId.USER_1, TodoId.SEQUENCE_NUMBER_1)),
