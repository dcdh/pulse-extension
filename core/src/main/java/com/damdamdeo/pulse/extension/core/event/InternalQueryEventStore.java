...
public abstract class InternalQueryEventStore<A extends AggregateRoot<K>, K extends AggregateId> implements QueryEventStore<A, K> {

    private final EventRepository<A, K> eventStore;
    private final ExecutionContextProvider executionContextProvider;

    protected InternalQueryEventStore(final EventRepository<A, K> eventStore,
