...
public record ExecutedByEncoded(String encoded) {
    ...
    public ExecutedByEncoded {
        ...
        Validate.validState(ExecutedBy.Anonymous.DISCRIMINANT.equals(encoded)
                ...
                || ExecutedBy.Banned.DISCRIMINANT.equals(encoded));
    }

    public ExecutedBy to(final UsernameDecoder usernameDecoder, final OwnedBy ownedBy) {
        ...
        try {
            ...
            } else if (encoded.equals(ExecutedBy.Banned.DISCRIMINANT)) {
                return ExecutedBy.Banned.INSTANCE;
            }
        } catch (final UnableToDecodeException e) {
            return ExecutedBy.Banned.INSTANCE;
        }
